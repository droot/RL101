...
### Participants
- **RL Training Loop**: The main training loop controller.
- **Generator**: Runs the $N$ Agentic Loops to gather data.
- **Dataset**: Source of prompts.
- **Model**: The active model used for generation.
- **Trainer**: Computes gradients and updates the model weights based on the batch data.
